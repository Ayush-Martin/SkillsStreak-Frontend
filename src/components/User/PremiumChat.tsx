...
import { BiSolidMessageSquareAdd, CgMenuGridO, FaLock } from "@/assets/icons";
    ...
    <div className="relative mt-3">
      <div className="relative">
        ...
        <Input
          ...
          className="px-3 pl-8 text-white bg-gray-700 border-gray-600 "
        />
      </div>
      {search && (
        <div className="absolute z-30 flex flex-col w-full gap-3 px-4 py-5 mt-2 bg-white max-h-52">
          {trainers.length ? (
            trainers
              .filter((trainer) =>
...
const PremiumChat = () => {
  ...
  return (
    <>
      ...
      <div className={`flex flex-col sm:flex-row h-[620px] relative `}>
        {chatAccess === false && (
